                        ...
                        <div class="col-md-12 mb-3">
                            <div class="detail">
                                ...
                                <div class="btn-group d-flex justify-content-center">
                                    <div><a href={{"/signup/{$city}/{$year}/{$month}/signup"}}> <input id="checkRead"
                                                class="btn btn-primary" type="button" value="個人報名"></a>
                                        <div>
                                        </div>
                                    </div>
                                    <div><a href={{"/teamSignup/{$city}/{$year}/{$month}/"}}><input class="btn btn-primary" type="button" value="團體報名"></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
