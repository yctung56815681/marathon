        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"></h5><i class="fas fa-exclamation-circle fa-8x" style="margin: 0 auto" ></i></h5>
                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="detail">
                                        ...
                                        <div class="btn-group d-flex justify-content-center">
                                            <div><input id="checkRead" class="btn btn-primary" type="button"
                                                    value="個人報名" onclick="goGroup2()">
                                                <div>
                                                </div>
                                            </div>
