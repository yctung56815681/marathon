                ...
                <table class="table table-striped table-bordered table-hover">
                    <thead class="table-info">
                        <tr>
                            ...
                            <th style="width:160px"><a class="btn btn-sm btn-success" role="button"
                                    href="/accountAdmin/create"><i class="far fa-plus-square"></i> 新增</a></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-info" role="button"
                                    href="/accountAdmin/{{$item->idAccount}}/edit"><i class="far fa-edit"></i> 編輯</a>
                                <button type="button" class="btn btn-sm btn-danger"
                                    onclick="$('#myModal{{$item->idAccount}}').modal('show');"><i class="far fa-trash-alt"></i> 刪除</button>
